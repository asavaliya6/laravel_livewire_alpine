<div class="p-6 bg-white rounded-lg shadow-md">
    ...
    <h2 class="text-2xl font-bold mt-6 mb-4">Task List</h2>

    <!-- Status Filter -->
    <div class="mb-4 flex space-x-4">
        <button 
            wire:click="$set('statusFilter', 'all')"
            class="px-4 py-2 bg-gray-300 rounded-md {{ $statusFilter === 'all' ? 'bg-blue-500 text-white' : '' }}">
            All
        </button>

        <button 
            wire:click="$set('statusFilter', 'Pending')"
            class="px-4 py-2 bg-gray-300 rounded-md {{ $statusFilter === 'Pending' ? 'bg-yellow-500 text-white' : '' }}">
            Pending
        </button>

        <button 
            wire:click="$set('statusFilter', 'Completed')"
            class="px-4 py-2 bg-gray-300 rounded-md {{ $statusFilter === 'Completed' ? 'bg-green-500 text-white' : '' }}">
            Completed
        </button>
    </div>
    ...
    <div class="p-4 border rounded-md bg-gray-100 mb-2 flex items-center justify-between">
        <div>
